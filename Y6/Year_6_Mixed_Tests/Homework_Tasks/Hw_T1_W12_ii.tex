...
\begin{center}
 \text{Potterhouse School. \hspace{1cm} Year 6 Math - Homework, Term 1, Week 12, Task (ii) } \qquad \\ 
\vspace{5pt}
...
% What fraction is shaded? Hint - numerator = shaded squares, denominator = all the squares (both shaded and unshaded). \\
...
% What percentage is shaded? Hint - convert the shaded fraction to percentage by multiplying by 100.\\
